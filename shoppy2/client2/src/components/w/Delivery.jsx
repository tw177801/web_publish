        ...
        <div>
            ...
            <div className="delivery-list-content">
                    ...
                    <div className="delivery-list-1">
                        ...
                        <div className='delivery-title-1'>
                            <h5>배송정보</h5>
                        </div>

                        <div className='delivery-ctn-1'>
                    ...
                    <div className="delivery-list-3">

                        <div className='delivery-title-3'>
                            <h5>반품/교환 불가능한 경우</h5>
                        </div>

                        <div className='delivery-ctn-3'>
                            <ul>
                    ...
                    <div className="delivery-list-4">

                        <div className='delivery-title-4'>
                            <h5>A/S 안내</h5>
                        </div>

                        <div className='delivery-ctn-4'>
                            <ul>
